...
/* by Ross Williams on 31-Dec-1990.                                           */
                            ...
                            /* INCLUDE FILES                                  */
                            /* =============                                  */
#include "COMPRESS.h"       /* Fast memory copy routine.                      */
...
uint32_t lzrw3_req_mem() { return MEM_REQ; };

void lzrw3_compress_compress  (UBYTE *,UBYTE *,uint32_t,UBYTE *,uint32_t *);
void lzrw3_compress_decompress(UBYTE *,UBYTE *,uint32_t,UBYTE *,uint32_t *);
...
*/
EXPORT void lzrw3_compress(UWORD action,UBYTE *wrk_mem,UBYTE *src_adr,uint32_t src_len,UBYTE *dst_adr,uint32_t *p_dst_len)
{
 switch (action)
   {
    case COMPRESS_ACTION_COMPRESS:
       lzrw3_compress_compress(wrk_mem,src_adr,src_len,dst_adr,p_dst_len);
       break;
    case COMPRESS_ACTION_DECOMPRESS:
       lzrw3_compress_decompress(wrk_mem,src_adr,src_len,dst_adr,p_dst_len);
       break;
   }
}
...
LOCAL void lzrw3_compress_compress
           (UBYTE *p_wrk_mem,UBYTE *p_src_first,uint32_t src_len,UBYTE *p_dst_first,uint32_t *p_dst_len)
...
/* Output : Upon completion guaranteed *p_dst_len<=src_len+FLAG_BYTES.        */
{
 ...
 UBYTE *p_control;
 register uint32_t control=TOPWORD;
